...
{{with songauthors}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Songauthorss_Songauthorss&mode={{~mode}}&={{id}}" method="POST"><input type="hidden" name="xss_token_songauthors" value="{{~xss_token_songauthors}}"/><section class="mb-4">
                ...
                <input type="text" id="artist_id" name="artist_id" placeholder="artist_id de songauthors " value="{{artist_id}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="song_id" name="song_id" placeholder="song_id de songauthors " value="{{song_id}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="song_author_created_at" name="song_author_created_at" placeholder="song_author_created_at de songauthors " value="{{song_author_created_at}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="song_author_last_update_at" name="song_author_last_update_at" placeholder="song_author_last_update_at de songauthors " value="{{song_author_last_update_at}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
