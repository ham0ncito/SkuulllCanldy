...
{{with song}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Songs_Songs&mode={{~mode}}&id_song={{id}}" method="POST"><input type="hidden" name="xss_token_song" value="{{~xss_token_song}}"/><section class="mb-4">
                ...
                <input type="text" id="id_song" name="id_song" placeholder="id_song de song " value="{{id_song}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="title_song" name="title_song" placeholder="title_song de song " value="{{title_song}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="duration" name="duration" placeholder="duration de song " value="{{duration}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="id_genre" name="id_genre" placeholder="id_genre de song " value="{{id_genre}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="song_cover" name="song_cover" placeholder="song_cover de song " value="{{song_cover}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="album_id" name="album_id" placeholder="album_id de song " value="{{album_id}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="status_song" name="status_song" placeholder="status_song de song " value="{{status_song}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="link_song" name="link_song" placeholder="link_song de song " value="{{link_song}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
