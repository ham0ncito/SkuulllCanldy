<div class="flex items-center justify-between mb-4">
    ...
    </div><section><h2 class="text-2xl font-bold mb-4"> LISTADO DE ROLES_USUARIOS</h2>
...
<tr>
	...
	<th class="py-2 px-4 border-b">ROLEUSEREXP</th><th><a href="index.php?page=Roles_usuarioss_Roles_usuarioss&mode=INS">Nuevo</a></th>
	</tr>
