<div class="flex items-center justify-between mb-4 mx-4">
    ...
    </div><section><h2 class="text-2xl font-bold mb-4 mx-4"> FAVORITES</h2>
...
<tr>
	...
	<th class="py-2 px-4 border-b">TYPE_FAVORITE</th><th><a href="index.php?page=Favoritess_Favoritess&mode=INS">Nuevo</a></th>
	</tr>
</thead><tbody>{{foreach favorites}}<tr><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Favoritess_Favoritess&mode=DSP&id_favorite={{id_favorite}} ">{{id_favorite}}</a></td><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Favoritess_Favoritess&mode=DSP&id_favorite={{id_favorite}} ">{{usercod}}</a></td><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Favoritess_Favoritess&mode=DSP&id_favorite={{id_favorite}} ">{{id_reference}}</a></td><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Favoritess_Favoritess&mode=DSP&id_favorite={{id_favorite}} ">{{type_favorite}}</a></td>
