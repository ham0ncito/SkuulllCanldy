...
{{with favorites}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Favoritess_Favoritess&mode={{~mode}}&id_favorite={{id}}" method="POST"><input type="hidden" name="xss_token_favorites" value="{{~xss_token_favorites}}"/><section class="mb-4">
                ...
                <input type="text" id="id_favorite" name="id_favorite" placeholder="id_favorite de favorites " value="{{id_favorite}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="usercod" name="usercod" placeholder="usercod de favorites " value="{{usercod}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="id_reference" name="id_reference" placeholder="id_reference de favorites " value="{{id_reference}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="type_favorite" name="type_favorite" placeholder="type_favorite de favorites " value="{{type_favorite}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
