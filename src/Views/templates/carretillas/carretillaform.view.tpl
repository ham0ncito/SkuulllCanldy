<section class="bg-gray-100 p-4 mx-4">
    <h1 class="text-2xl font-bold mb-4"> Descripcion carretilla {{modedsc}}</h1>
...
{{with carretilla}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Carretillas_Carretillas&mode={{~mode}}&usercod={{id}}" method="POST"><input type="hidden" name="xss_token_carretilla" value="{{~xss_token_carretilla}}"/><section class="mb-4">
                ...
                <input type="text" id="usercod" name="usercod" placeholder="usercod de carretilla " value="{{usercod}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="productid" name="productid" placeholder="productid de carretilla " value="{{productid}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="crrctd" name="crrctd" placeholder="crrctd de carretilla " value="{{crrctd}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="crrprc" name="crrprc" placeholder="crrprc de carretilla " value="{{crrprc}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="crrfching" name="crrfching" placeholder="crrfching de carretilla " value="{{crrfching}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
