...
{{with carretillaanon}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Carretillaanons_Carretillaanons&mode={{~mode}}&anoncod={{id}}" method="POST"><input type="hidden" name="xss_token_carretillaanon" value="{{~xss_token_carretillaanon}}"/><section class="mb-4">
                ...
                <input type="text" id="anoncod" name="anoncod" placeholder="anoncod de carretillaanon " value="{{anoncod}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="productid" name="productid" placeholder="productid de carretillaanon " value="{{productid}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="crrctd" name="crrctd" placeholder="crrctd de carretillaanon " value="{{crrctd}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="crrprc" name="crrprc" placeholder="crrprc de carretillaanon " value="{{crrprc}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="crrfching" name="crrfching" placeholder="crrfching de carretillaanon " value="{{crrfching}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
