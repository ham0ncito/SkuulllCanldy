<section class="bg-gray-100 p-4 mx-4">
    <h1 class="text-2xl font-bold mb-4"> Descripcion highligths {{modedsc}}</h1>
...
{{with highligths}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Highligthss_Highligthss&mode={{~mode}}&highligths_id={{id}}" method="POST"><input type="hidden" name="xss_token_highligths" value="{{~xss_token_highligths}}"/><section class="mb-4">
                ...
                <input type="text" id="highligths_id" name="highligths_id" placeholder="highligths_id de highligths " value="{{highligths_id}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="highligths_starts_at" name="highligths_starts_at" placeholder="highligths_starts_at de highligths " value="{{highligths_starts_at}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="highligths_ends_at" name="highligths_ends_at" placeholder="highligths_ends_at de highligths " value="{{highligths_ends_at}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="highligths_time" name="highligths_time" placeholder="highligths_time de highligths " value="{{highligths_time}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
