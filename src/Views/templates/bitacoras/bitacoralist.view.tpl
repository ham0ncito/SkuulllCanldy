...
<thead>
<tr>
	<th class="py-2 px-4 border-b">BITACORACOD</th>
	<th class="py-2 px-4 border-b">BITACORAFCH</th>
	<th class="py-2 px-4 border-b">BITPROGRAMA</th>
	<th class="py-2 px-4 border-b">BITDESCRIPCION</th>
	<th class="py-2 px-4 border-b">BITOBSERVACION</th>
	<th class="py-2 px-4 border-b">BITTIPO</th>
	<th class="py-2 px-4 border-b">BITUSUARIO</th><th><a href="index.php?page=Bitacoras_Bitacoras&mode=INS">Nuevo</a></th>
	</tr>
