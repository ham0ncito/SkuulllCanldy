...
{{with genre}}
    ...
    <form class="my-4 mx-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Genres_Genres&mode={{~mode}}&id_genre={{id}}" method="POST"><input type="hidden" name="xss_token_genre" value="{{~xss_token_genre}}"/><section class="mb-4">
                ...
                <input type="text" id="id_genre" name="id_genre" placeholder="id_genre de genre " value="{{id_genre}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="name_genre" name="name_genre" placeholder="name_genre de genre " value="{{name_genre}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="description_genre" name="description_genre" placeholder="description_genre de genre " value="{{description_genre}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="status_genre" name="status_genre" placeholder="status_genre de genre " value="{{status_genre}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="image_genre" name="image_genre" placeholder="image_genre de genre " value="{{image_genre}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
