...
{{with subscriptionuser}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Subscriptionusers_Subscriptionusers&mode={{~mode}}&usercod={{id}}" method="POST"><input type="hidden" name="xss_token_subscriptionuser" value="{{~xss_token_subscriptionuser}}"/><section class="mb-4">
                ...
                <input type="text" id="usercod" name="usercod" placeholder="usercod de subscriptionuser " value="{{usercod}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="id_subscription" name="id_subscription" placeholder="id_subscription de subscriptionuser " value="{{id_subscription}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="purchase_date_subscription" name="purchase_date_subscription" placeholder="purchase_date_subscription de subscriptionuser " value="{{purchase_date_subscription}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="purchase_date_end" name="purchase_date_end" placeholder="purchase_date_end de subscriptionuser " value="{{purchase_date_end}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="status_subscription" name="status_subscription" placeholder="status_subscription de subscriptionuser " value="{{status_subscription}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
