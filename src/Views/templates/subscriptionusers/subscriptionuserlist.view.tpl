...
<div class="flex items-center justify-between mb-4 mx-4">
    ...
    </div>{{ifnot IsEmpty}}<section><h2 class="text-2xl font-bold mb-4 mx-4"> SUBSCRIPTIONUSER</h2>
...
<tr>
	...
	<th class="py-2 px-2 text-center justify-center text-white bg-blue-500 border-b">PURCHASE_DATE_SUBSCRIPTION</th>
	<th class="py-2 px-2 text-center justify-center text-white bg-blue-500 border-b">PURCHASE_DATE_END</th>
	<th class="py-2 px-2 text-center justify-center text-white bg-blue-500 border-b">STATUS_SUBSCRIPTION</th><th class="py-2 px-2 text-center justify-center text-white bg-blue-500 border-b"><a href="index.php?page=Subscriptionusers_Subscriptionusers&mode=INS">ADD</a></th>
	</tr>
