<section class="bg-gray-100 p-4 mx-4">
    <h1 class="text-2xl font-bold mb-4"> Descripcion subscription {{modedsc}}</h1>
...
{{with subscription}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Subscriptions_Subscriptions&mode={{~mode}}&id_subscription={{id}}" method="POST"><input type="hidden" name="xss_token_subscription" value="{{~xss_token_subscription}}"/><section class="mb-4">
                ...
                <input type="text" id="id_subscription" name="id_subscription" placeholder="id_subscription de subscription " value="{{id_subscription}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="subscription_description" name="subscription_description" placeholder="subscription_description de subscription " value="{{subscription_description}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="subscription_duration" name="subscription_duration" placeholder="subscription_duration de subscription " value="{{subscription_duration}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="subscription_price" name="subscription_price" placeholder="subscription_price de subscription " value="{{subscription_price}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
