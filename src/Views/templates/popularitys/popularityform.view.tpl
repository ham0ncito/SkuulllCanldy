...
{{with popularity}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Popularitys_Popularitys&mode={{~mode}}&id_popularity={{id}}" method="POST"><input type="hidden" name="xss_token_popularity" value="{{~xss_token_popularity}}"/><section class="mb-4">
                ...
                <input type="text" id="id_popularity" name="id_popularity" placeholder="id_popularity de popularity " value="{{id_popularity}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="id_object" name="id_object" placeholder="id_object de popularity " value="{{id_object}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="dislike_count" name="dislike_count" placeholder="dislike_count de popularity " value="{{dislike_count}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="like_count" name="like_count" placeholder="like_count de popularity " value="{{like_count}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="percent_dislike" name="percent_dislike" placeholder="percent_dislike de popularity " value="{{percent_dislike}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="percent_like" name="percent_like" placeholder="percent_like de popularity " value="{{percent_like}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="type_object" name="type_object" placeholder="type_object de popularity " value="{{type_object}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
