<section class="bg-gray-100 p-4 mx-4">
    <h1 class="text-2xl font-bold mb-4"> Descripcion funciones {{modedsc}}</h1>
...
{{with funciones}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Funcioness_Funcioness&mode={{~mode}}&fncod={{id}}" method="POST"><input type="hidden" name="xss_token_funciones" value="{{~xss_token_funciones}}"/><section class="mb-4">
                ...
                <input type="text" id="fncod" name="fncod" placeholder="fncod de funciones " value="{{fncod}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="fndsc" name="fndsc" placeholder="fndsc de funciones " value="{{fndsc}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="fnest" name="fnest" placeholder="fnest de funciones " value="{{fnest}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="fntyp" name="fntyp" placeholder="fntyp de funciones " value="{{fntyp}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
