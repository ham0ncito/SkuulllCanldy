...
{{with lognonuser}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Lognonusers_Lognonusers&mode={{~mode}}&id_logNonUser={{id}}" method="POST"><input type="hidden" name="xss_token_lognonuser" value="{{~xss_token_lognonuser}}"/><section class="mb-4">
                ...
                <input type="text" id="id_lognonuser" name="id_lognonuser" placeholder="id_lognonuser de lognonuser " value="{{id_lognonuser}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="log_date" name="log_date" placeholder="log_date de lognonuser " value="{{log_date}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="id_cookie" name="id_cookie" placeholder="id_cookie de lognonuser " value="{{id_cookie}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="log_cod" name="log_cod" placeholder="log_cod de lognonuser " value="{{log_cod}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
