<div class="flex items-center justify-between mb-4">
    ...
    </div><section><h2 class="text-2xl font-bold mb-4"> LISTADO DE ROLES</h2>
...
<tr>
	...
	<th class="py-2 px-4 border-b">ROLESEST</th><th><a href="index.php?page=Roless_Roless&mode=INS">Nuevo</a></th>
	</tr>
