  ...
  <main class="flex flex-wrap">
    ...
    <aside id="sidebar" class="bg-gray-800 w-20 text-white w-10 mb-10 fixed left-0 top-0 h-screen" >
        <div id="sidebar-content" class="flex justify-center flex-wrap items-center rounded-lg  mt-5 mb-20 " >
          <div class="mt-4 p-2 rounded-full hover:bg-pink-500 transition duration-300 ease-in-out">
    <a href="index.php?page=Home_Home" onclick="anchorClick(event, this)" >
        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#f2f2f2">
            ...
            {{if ~isCLS}}
          <div class="m-2 p-2 rounded-full hover:bg-pink-500 transition duration-300 ease-in-out">
    <a href="index.php?page=Search_Search" onclick="anchorClick(event, this)">
        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
                <path d="M15.7955 15.8111L21 21M18 10.5C18 14.6421 14.6421 18 10.5 18C6.35786 18 3 14.6421 3 10.5C3 6.35786 6.35786 3 10.5 3C14.6421 3 18 6.35786 18 10.5Z" stroke="#fffafa" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            </g>
        </svg>
    </a>
</div>
...
{{endif ~isADMIN}}
    ...
    <section id="content" class="w-full h-screen md:w-2/3 flex-1 min-w-0 mb-10 mt-4 mr-4 ml-20">
      <header class="bg-gray-800 mx-4 rounded-lg mb-4 text-white py-4 flex items-center justify-around">
        <nav id="menu" class=" px-auto md:block">
        ...
        <div class="rounded-lg ml-0 text-white py-4 pl-0 px-8 flex items-center" id="playerInfo">
          ...
          <div class="track-info pr-4">
              <h2 class="text-lg" id="songTitle">Song Title</h2>
              <p class="text-sm" id="artistName">Artist Name</p>
          </div>
      ...
      <div class="container align-center justify-center">
        <div class="mt-16 mx-auto mb-16" id="main-content">
          {{{page_content}}}
          <script>
