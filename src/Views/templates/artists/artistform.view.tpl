...
{{with artist}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Artists_Artists&mode={{~mode}}&id_artist={{id}}" method="POST"><input type="hidden" name="xss_token_artist" value="{{~xss_token_artist}}"/><section class="mb-4">
                ...
                <input type="text" id="id_artist" name="id_artist" placeholder="id_artist de artist " value="{{id_artist}}" {{if ~readonly}}   readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="name_artist" name="name_artist" placeholder="name_artist de artist " value="{{name_artist}}" {{if ~readonly}}   readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
            ...
            {{if isADMIN}}<section class="mb-4">
                ...
                <input type="text" id="image_artist" name="image_artist" placeholder="image_artist de artist " value="{{image_artist}}" {{if ~readonly}}   readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                {{if image_artist_error}}<div class="text-red-500 text-sm">{{image_artist_error}}</div>{{endif image_artist_error}}
            </section><section class="mb-4"> {{endif isADMIN}}
                <label for="date_of_birth_artist" class="block text-gray-700 text-sm font-bold mb-2">date_of_birth_artist</label>
                <input type="text" id="date_of_birth_artist" name="date_of_birth_artist" placeholder="date_of_birth_artist de artist " value="{{date_of_birth_artist}}" {{if ~readonly}}   readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="country_artist" name="country_artist" placeholder="country_artist de artist " value="{{country_artist}}" {{if ~readonly}}   readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="status_artist" name="status_artist" placeholder="status_artist de artist " value="{{status_artist}}" {{if ~readonly}}   readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="artist_bio" name="artist_bio" placeholder="artist_bio de artist " value="{{artist_bio}}" {{if ~readonly}}   readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
