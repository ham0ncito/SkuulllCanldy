<section class="bg-gray-100  rounded-lg shadow-lg p-4 mx-8">
    <h2 class="text-2xl font-bold text-white text-center mb-6"> Descripcion playlistsongs {{modedsc}}</h2>
...
{{with playlistsongs}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Playlistsongss_Playlistsongss&mode={{~mode}}&playlist_id={{id}}" method="POST"><input type="hidden" name="xss_token_playlistsongs" value="{{~xss_token_playlistsongs}}"/><section class="mb-4">
                ...
                <input type="text" id="playlist_id" name="playlist_id" placeholder="playlist_id de playlistsongs " value="{{playlist_id}}" {{if ~readonly}}   readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="song_id" name="song_id" placeholder="song_id de playlistsongs " value="{{song_id}}" {{if ~readonly}}   readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="playlistsong_added_at" name="playlistsong_added_at" placeholder="playlistsong_added_at de playlistsongs " value="{{playlistsong_added_at}}" {{if ~readonly}}   readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="playlistsong_status" name="playlistsong_status" placeholder="playlistsong_status de playlistsongs " value="{{playlistsong_status}}" {{if ~readonly}}   readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
