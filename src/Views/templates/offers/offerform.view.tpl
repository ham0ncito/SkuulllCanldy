...
{{with offer}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Offers_Offers&mode={{~mode}}&id_offer={{id}}" method="POST"><input type="hidden" name="xss_token_offer" value="{{~xss_token_offer}}"/><section class="mb-4">
                ...
                <input type="text" id="id_offer" name="id_offer" placeholder="id_offer de offer " value="{{id_offer}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="offer_description" name="offer_description" placeholder="offer_description de offer " value="{{offer_description}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="offer_starts_at" name="offer_starts_at" placeholder="offer_starts_at de offer " value="{{offer_starts_at}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="offer_ends_at" name="offer_ends_at" placeholder="offer_ends_at de offer " value="{{offer_ends_at}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="offer_status" name="offer_status" placeholder="offer_status de offer " value="{{offer_status}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
