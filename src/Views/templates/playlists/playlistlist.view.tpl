<div class="flex items-center justify-between mb-4 mx-4">
        <div class="relative w-full flex items-center">
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                ...
                <a href="index.php?page=Playlists_Playlists&mode=INS" class="px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700">
                    Insert
                </a>
            </div>
        </div>
    </div>{{ifnot isEmpty}}<section><h2 class="text-2xl font-bold mb-4 mx-4"> PLAYLIST</h2>
...
<tr>
	...
	<th class="py-2 px-2 text-center justify-center text-white bg-blue-500 border-b">USERCOD</th><th class="py-2 px-2 text-center justify-center text-white bg-blue-500 border-b"><a href="index.php?page=Playlists_Playlists&mode=INS">ADD</a></th>
            ...
            <td class"p-2 text-center">
                <a class="text-green-500 hover:text-green-700" href="index.php?page=Playlists_Playlists&mode=UPD&id_playlist={{id_playlist}}" >Edit</a> 
                <a class="text-red-500 hover:text-red-700" href="index.php?page=Playlists_Playlists&mode=DEL&id_playlist={{id_playlist}}" >Delete</a>
            </td>
	</tr>
