...
{{with playlist}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Playlists_Playlists&mode={{~mode}}&id_playlist={{id}}" method="POST"><input type="hidden" name="xss_token_playlist" value="{{~xss_token_playlist}}"/><section class="mb-4">
                ...
                <input type="text" id="id_playlist" name="id_playlist" placeholder="id_playlist de playlist " value="{{id_playlist}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="playlist_name" name="playlist_name" placeholder="playlist_name de playlist " value="{{playlist_name}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="playlist_description" name="playlist_description" placeholder="playlist_description de playlist " value="{{playlist_description}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="playlist_image" name="playlist_image" placeholder="playlist_image de playlist " value="{{playlist_image}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="playlist_create_at" name="playlist_create_at" placeholder="playlist_create_at de playlist " value="{{playlist_create_at}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="playlist_status" name="playlist_status" placeholder="playlist_status de playlist " value="{{playlist_status}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="usercod" name="usercod" placeholder="usercod de playlist " value="{{usercod}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
