<div class="flex items-center justify-between mb-4 mx-4">
    ...
    </div>{{ifnot isEmpty}}<section><h2 class="text-2xl font-bold mb-4 mx-4"> LOG</h2>
...
<tr>
	...
	<th class="py-2 px-2 text-center justify-center text-white bg-blue-500 border-b">LOG_DESCRIPTION</th><th class="py-2 px-2 text-center justify-center text-white bg-blue-500 border-b"><a href="index.php?page=Logs_Logs&mode=INS">ADD</a></th>
	</tr>
</thead><tbody>{{foreach log}}<tr><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Logs_Logs&mode=DSP&={{log_cod}}">{{log_cod}}</a></td><td class="p-2 text-center"><a class="text-blue-500 hover:text-blue-700" href="index.php?page=Logs_Logs&mode=DSP&={{log_cod}} ">{{log_description}}</a></td>
            <td class"p-2 text-center">
                <a class="text-green-500 hover:text-green-700" href="index.php?page=Logs_Logs&mode=UPD&={{log_cod}}" >Edit</a> 
                <a class="text-red-500 hover:text-red-700" href="index.php?page=Logs_Logs&mode=DEL&={{log_cod}}" >Delete</a>
            </td>
	</tr>
 {{endfor log}}</tbody>
</table>
