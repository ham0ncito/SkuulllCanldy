...
{{with funciones_roles}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Funciones_roless_Funciones_roless&mode={{~mode}}&rolescod={{id}}" method="POST"><input type="hidden" name="xss_token_funciones_roles" value="{{~xss_token_funciones_roles}}"/><section class="mb-4">
                ...
                <input type="text" id="rolescod" name="rolescod" placeholder="rolescod de funciones_roles " value="{{rolescod}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="fncod" name="fncod" placeholder="fncod de funciones_roles " value="{{fncod}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="fnrolest" name="fnrolest" placeholder="fnrolest de funciones_roles " value="{{fnrolest}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="fnexp" name="fnexp" placeholder="fnexp de funciones_roles " value="{{fnexp}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
