<div class="flex items-center justify-between mb-4 mx-4">
    ...
    </div>{{ifnot isEmpty}}<section><h2 class="text-2xl font-bold mb-4 mx-4"> HIGHLIGTHSPLAYLIST</h2>
...
<tr>
	...
	<th class="py-2 px-2 text-center justify-center text-white bg-blue-500 border-b">HIGHLIGTHS_DESCRIPTION</th>
    {{if ~isADMIN}}<th class="py-2 px-2 text-center justify-center text-white bg-blue-500 border-b"><a href="index.php?page=Highligthsplaylists_Highligthsplaylists&mode=INS">ADD</a></th>{{endif ~isADMIN}}
	</tr>
