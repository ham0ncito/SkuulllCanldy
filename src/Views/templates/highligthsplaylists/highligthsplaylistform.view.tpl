...
{{with highligthsplaylist}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Highligthsplaylists_Highligthsplaylists&mode={{~mode}}&highligths_id={{id}}" method="POST"><input type="hidden" name="xss_token_highligthsplaylist" value="{{~xss_token_highligthsplaylist}}"/><section class="mb-4">
                ...
                <input type="text" id="highligths_id" name="highligths_id" placeholder="highligths_id de highligthsplaylist " value="{{highligths_id}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="playlist_id" name="playlist_id" placeholder="playlist_id de highligthsplaylist " value="{{playlist_id}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
                ...
                <input type="text" id="highligths_description" name="highligths_description" placeholder="highligths_description de highligthsplaylist " value="{{highligths_description}}" {{if ~readonly}} disabled readonly {{endif ~readonly}} class="w-full py-2 px-3 border border-gray-300 rounded focus:outline-none focus:border-blue-400"/>
